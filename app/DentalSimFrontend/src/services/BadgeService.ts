...
const mockDiagnosisOptions: DiagnosisOption[] = [
    ...
    // --- Non-Endodontic Diagnoses ---
    {
        id: 'sialolithiasis',
        name: 'Sialolithiasis',
        description: 'Salivary gland stone causing obstruction and swelling',
        category: 'Non-endodontic',
        referral: 'Refer to Maxillofacial Surgery',
    },
    {
        id: 'otitis',
        name: 'Otitis',
        description: 'Inflammation of the ear causing referred pain to the jaw area',
        category: 'Non-endodontic',
        referral: 'Refer to ENT',
    },
    {
        id: 'peritonsillar-abscess',
        name: 'Peritonsillar Abscess',
        description: 'Collection of pus beside the tonsil causing throat and jaw pain',
        category: 'Non-endodontic',
        referral: 'Refer to Maxillofacial Surgery',
    },
    {
        ...
        description: 'Severe episodic facial pain along the trigeminal nerve distribution',
        category: 'Non-endodontic',
        referral: 'Refer to Neurologist',
    },
    {
        id: 'tmj-pain',
        name: 'TMJ Pain',
        description: 'Pain originating from the temporomandibular joint',
        category: 'Non-endodontic',
        referral: 'Refer to Maxillofacial Surgeon',
    },
    {
        id: 'denture-related-pain',
        name: 'Denture-Related Pain',
        description: 'Pain caused by ill-fitting or problematic dentures',
        category: 'Non-endodontic',
        referral: 'Refer to Prosthodontist',
    },
];
